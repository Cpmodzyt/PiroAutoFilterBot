...
API_ID = int(environ.get('API_ID', '23023343'))
API_HASH = environ.get('API_HASH', '2b79fd2d2c83173807a039325e7e166f')
BOT_TOKEN = environ.get('BOT_TOKEN', '7393027154:AAHemwtEvsNSao2lii1QXXsJBGUl7rC92S0')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7717701360').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002324232643').split()]
...
SUPPORT_CHAT_ID = -1001865863393
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://interworld:itzmecp@cluster0.jfui5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002486369809))
